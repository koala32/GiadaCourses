...
module.exports = function(app, sharedState) {
  ...
  app.get('/api/changelog', (req, res) => {
    res.json([
      { version: '11.5', date: '2026-04-09', title: 'Classifica Rinnovata', changes: ['Classifica completamente ridisegnata e piu bella','Vedi subito la tua posizione in classifica','Nuovi filtri: XP Totale, Settimana, Streak e Esercizi completati','Podio top 3 con medaglie oro argento e bronzo','Accesso rapido alla classifica dalla Home','Tutti i punteggi storici sono mantenuti'] },
