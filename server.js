// ============================================================
//  GiadaCourses v8.0 — Linux Production Build (SECURITY HARDENED)
//  Socket.IO + WebRTC + LIVE + Storie + Sfide 1v1 + Media
//  + Campanellina notifiche + Rate Limiting + Security Headers
//  + Anti-cheat sfide + Session expiry + Upload validation
// ============================================================
...
app.get('/api/ping', (req, res) => {
  res.json({ ok: true, ts: Date.now(), version: '8.0-secure', env: 'linux', uploadsDir: UPLOADS_DIR });
});
...
setupFirstRun().then(() => {
  ...
  httpServer.listen(PORT, '127.0.0.1', () => {
    serverLog('ok', '=============================================');
    serverLog('ok', 'GiadaCourses v8.0 ONLINE su Linux! (SECURITY HARDENED)');
    serverLog('ok', 'Socket.IO + WebRTC + SSE + Anti-Cheat + Bell + RateLimit');
    serverLog('ok', '=============================================');
